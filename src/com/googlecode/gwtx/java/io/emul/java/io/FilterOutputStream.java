 ...
 * http://svn.apache.org/repos/asf/harmony/enhanced/classlib/trunk/modules/luni/src/main/java/java/io/FilterOutputStream.java
 */
...
public class FilterOutputStream extends OutputStream {
    ...
    public void write(byte buffer[], int offset, int count) throws IOException {
        ...
        if (offset > buffer.length || offset < 0 || count < 0
            ...
            throw new ArrayIndexOutOfBoundsException("Arguments out of bounds"); //$NON-NLS-1$
        }
