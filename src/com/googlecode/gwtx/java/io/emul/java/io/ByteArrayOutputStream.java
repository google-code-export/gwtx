 ...
 * http://svn.apache.org/repos/asf/harmony/enhanced/classlib/trunk/modules/luni/src/main/java/java/io/ByteArrayOutputStream.java
 */
...
public class ByteArrayOutputStream extends OutputStream {
    ...
    public synchronized void write(byte[] buffer, int offset, int len) {
        ...
        if (offset < 0 || offset > buffer.length || len < 0
            ...
            throw new IndexOutOfBoundsException("Arguments out of bounds"); //$NON-NLS-1$
        }
        if (len == 0) {
            return;
        }
