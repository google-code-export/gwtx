...
import java.io.OutputStream; // FIXME? OutputStream
import java.io.OutputStreamWriter; // FIXME: OutputStreamWriter
import java.io.UnsupportedEncodingException; // FIXME: UnsupportedEncodingException
import java.io.Writer; // FIXME: Writer
...
public class StreamHandler extends Handler {
    ...
    public StreamHandler(OutputStream os, Formatter formatter) {
        ...
        if (os == null) {
            ...
            throw new NullPointerException("The OutputStream parameter is null."); //$NON-NLS-1$
        }
        if (formatter == null) {
            // logging.3=The Formatter parameter is null.
            throw new NullPointerException("The Formatter parameter is null."); //$NON-NLS-1$
        }
        this.os = os;
