...
import java.security.BasicPermission; // FIXME: BasicPermission
import java.security.Guard; // FIXME: Guard
...
public final class LoggingPermission extends BasicPermission implements Guard,
    ...
    public LoggingPermission(String name, String actions) {
        ...
        if (null != actions && !"".equals(actions)) { //$NON-NLS-1$
            ...
            throw new IllegalArgumentException("Actions must be either null or the empty string."); //$NON-NLS-1$
        }
    }
